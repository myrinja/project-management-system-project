...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("postgresql://posthaven_user:U2nAG4OZl2cuRz06CUyEC9RWB3mZrrrU@dpg-cl54kcil7jac73cc35r0-a.oregon-postgres.render.com/posthavenI")
#DATABASE_URI
#'sqlite:///blog.db'
